...
const CREATE_TABLE_QUERY = "CREATE TABLE IF NOT EXISTS $TABLE_STEP_RECORD ($COLUMN_DAY INTEGER, $COLUMN_WEEK_OF_YEAR INTEGER, $COLUMN_MONTH INTEGER, $COLUMN_YEAR INTEGER, $COLUMN_COUNT INTEGER,  PRIMARY KEY ($COLUMN_DAY, $COLUMN_WEEK_OF_YEAR, $COLUMN_MONTH, $COLUMN_YEAR))";
@entity
class StepRecord {
  @primaryKey
  final int day;
